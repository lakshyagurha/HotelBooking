  ...
  return (
    <>
      <header className="flex justify-between px-16">
        ...
        <div className="flex gap-2 border border-grey-300 rounded-full py-2 px-4 shadow-md shadow-gray-300 pt-2.5">
          ...
          <button className="bg-primary text-white p-1 rounded-full h-6">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
